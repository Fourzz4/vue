<template>
  ...
  <div class="adMins">
    <div class="admin-tools">
      <el-button type="warning" color="#006699" @click="refresh"
        ><el-icon>
          <Refresh /> </el-icon
        >刷新</el-button
      >
      <el-button type="warning" color="#006699" @click="toAdd" v-if="permission()"
        ><el-icon>
          <Plus /> </el-icon
        >添加</el-button
      >
      <el-button type="warning" @click="selectById" icon="Search"
        >按ID查询</el-button
      >
    </div>
    <el-table :data="adMins" style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="120" v-if="permission()">
        <template #default="scope">
          <el-button link type="success" size="small" @click="torole(scope.row)"
            ><el-icon>
              <Setting /> </el-icon
            >设置管理员</el-button
          >
